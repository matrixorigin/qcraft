...
CREATE TABLE public_airport_service (
    city_code text,
    airport_code text,
...
CREATE TABLE public_class_of_service (
...
CREATE TABLE public_code_description (
    code text DEFAULT '' NOT NULL,
    description text
);


CREATE TABLE public_compartment_class (
    compartment text,
    class_type text
);


CREATE TABLE public_days (
    days_code text,
    day_name text
);


CREATE TABLE public_dual_carrier (
    main_airline text,
...
CREATE TABLE public_equipment_sequence (
    aircraft_code_sequence text,
    aircraft_code text
);


CREATE TABLE public_fare (
...
CREATE TABLE public_fare_basis (
    fare_basis_code text,
    booking_class text,
    class_type text,
    premium text,
...
CREATE TABLE public_flight_fare (
    flight_id bigint,
    fare_id bigint
);


CREATE TABLE public_flight_leg (
    flight_id bigint,
    leg_number bigint,
    leg_flight bigint
);
...
CREATE TABLE public_flight_stop (
    flight_id bigint,
    stop_number bigint,
    stop_days text,
    stop_airport text,
...
CREATE TABLE public_food_service (
    meal_code text,
    meal_number bigint,
    compartment text,
...
CREATE TABLE public_ground_service (
    city_code text,
    airport_code text,
    transport_type text,
    ground_fare bigint
...
CREATE TABLE public_month (
    month_number bigint,
    month_name text
);


CREATE TABLE public_restriction (
    restriction_code text,
...
CREATE TABLE public_time_interval (
    period text,
    begin_time bigint,
    end_time bigint
);
...
INSERT INTO public_aircraft (aircraft_code, aircraft_description, manufacturer, basic_type, engines, propulsion, wide_body, wing_span, length, weight, capacity, pay_load, cruising_speed, range_miles, pressurized) VALUES
...
INSERT INTO public_airline (airline_code, airline_name, note) VALUES
...
INSERT INTO public_airport (airport_code, airport_name, airport_location, state_code, country_name, time_zone_code, minimum_connect_time) VALUES
...
INSERT INTO public_airport_service (city_code, airport_code, miles_distant, direction, minutes_distant) VALUES
('NYC', 'JFK', 10, 'North', 20),
('NYC', 'JFK', 20, 'South', 40),
('NYC', 'JFK', 30, 'East', 60),
('NYC', 'JFK', 40, 'West', 80),
...
INSERT INTO public_city (city_code, city_name, state_code, country_name, time_zone_code) VALUES
...
INSERT INTO public_class_of_service (booking_class, tier, class_description) VALUES
('First', 1, 'First Class'),
('Business', 2, 'Business Class'),
('Economy', 3, 'Economy Class')
;

INSERT INTO public_code_description (code, description) VALUES
('ABC', 'Code ABC'),
('DEF', 'Code DEF'),
('GHI', 'Code GHI'),
('JKL', 'Code JKL'),
...
INSERT INTO public_compartment_class (compartment, class_type) VALUES
('First', 'First Class'),
('Business', 'Business Class'),
('Economy', 'Economy Class')
;

INSERT INTO public_days (days_code, day_name) VALUES
('1', 'Monday'),
('2', 'Tuesday'),
('3', 'Wednesday'),
('4', 'Thursday'),
...
INSERT INTO public_dual_carrier (main_airline, low_flight_number, high_flight_number, dual_airline, service_name) VALUES
...
INSERT INTO public_equipment_sequence (aircraft_code_sequence, aircraft_code) VALUES
('1', 'B747'),
('2', 'A320'),
('3', 'B737'),
('4', 'A380'),
...
INSERT INTO public_fare (fare_id, from_airport, to_airport, fare_basis_code, fare_airline, restriction_code, one_direction_cost, round_trip_cost, round_trip_required) VALUES
...
INSERT INTO public_fare_basis (fare_basis_code, booking_class, class_type, premium, economy, discounted, night, season, basis_days) VALUES
...
INSERT INTO public_flight (flight_id, flight_days, from_airport, to_airport, departure_time, arrival_time, airline_flight, airline_code, flight_number, aircraft_code_sequence, meal_code, stops, connections, dual_carrier, time_elapsed) VALUES
...
INSERT INTO public_flight_fare (flight_id, fare_id) VALUES
(1, 1),
(2, 2),
(3, 3),
(4, 4),
...
INSERT INTO public_flight_leg (flight_id, leg_number, leg_flight) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
INSERT INTO public_flight_stop (flight_id, stop_number, stop_days, stop_airport, arrival_time, arrival_airline, arrival_flight_number, departure_time, departure_airline, departure_flight_number, stop_time) VALUES
...
INSERT INTO public_food_service (meal_code, meal_number, compartment, meal_description) VALUES
...
INSERT INTO public_ground_service (city_code, airport_code, transport_type, ground_fare) VALUES
('NYC', 'JFK', 'Taxi', 50),
('NYC', 'JFK', 'Shuttle', 40),
('NYC', 'JFK', 'Bus', 30),
...
INSERT INTO public_month (month_number, month_name) VALUES
(1, 'January'),
(2, 'February'),
(3, 'March'),
(4, 'April'),
...
INSERT INTO public_restriction (restriction_code, advance_purchase, stopovers, saturday_stay_required, minimum_stay, maximum_stay, application, no_discounts) VALUES
...
INSERT INTO public_state (state_code, state_name, country_name) VALUES
...
INSERT INTO public_time_interval (period, begin_time, end_time) VALUES
...
INSERT INTO public_time_zone (time_zone_code, time_zone_name, hours_from_gmt) VALUES
