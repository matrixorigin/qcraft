...
CREATE TABLE public_comment_instructor (
...
CREATE TABLE public_course_offering (
...
CREATE TABLE public_course_prerequisite (
    pre_course_id bigint NOT NULL,
    course_id bigint NOT NULL
);


CREATE TABLE public_course_tags_count (
    course_id bigint DEFAULT '0'::bigint NOT NULL,
...
CREATE TABLE public_instructor (
    instructor_id bigint DEFAULT '0'::bigint NOT NULL,
    name text,
    uniqname text
);
...
CREATE TABLE public_offering_instructor (
...
CREATE TABLE public_program_course (
...
CREATE TABLE public_program_requirement (
    program_id bigint NOT NULL,
...
CREATE TABLE public_student_record (
    student_id bigint NOT NULL,
    course_id bigint NOT NULL,
...
INSERT INTO public_area (course_id, area) VALUES
(1, 'Computer Science'),
(2, 'Mathematics'),
(3, 'Physics'),
(4, 'Computer Science')
...
INSERT INTO public_comment_instructor (instructor_id, student_id, score, comment_text) VALUES
(1, 1, 5, 'John Smith is a great instructor.'),
(2, 2, 4, 'Jane Doe explains concepts clearly.')
;

INSERT INTO public_course (course_id, name, department, number, credits, advisory_requirement, enforced_requirement, description, num_semesters, num_enrolled, has_discussion, has_lab, has_projects, has_exams, num_reviews, clarity_score, easiness_score, helpfulness_score) VALUES
...
INSERT INTO public_course_offering (offering_id, course_id, semester, section_number, start_time, end_time, monday, tuesday, wednesday, thursday, friday, saturday, sunday, has_final_project, has_final_exam, textbook, class_address, allow_audit) VALUES
...
INSERT INTO public_instructor (instructor_id, name, uniqname) VALUES
(1, 'John Smith', 'jsmith'),
(2, 'Jane Doe', 'jdoe'),
...
INSERT INTO public_offering_instructor (offering_instructor_id, offering_id, instructor_id) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 3),
(4, 3, 1),
...
INSERT INTO public_program (program_id, name, college, introduction) VALUES
...
INSERT INTO public_program_course (program_id, course_id, workload, category) VALUES
(1, 1, 100, 'Core'),
(1, 4, 80, 'Elective'),
(2, 2, 90, 'Core'),
(3, 3, 70, 'Core')
...
INSERT INTO public_program_requirement (program_id, category, min_credit, additional_req) VALUES
(1, 'Core', 120, NULL),
(2, 'Core', 90, NULL),
(3, 'Core', 200, NULL)
;

INSERT INTO public_semester (semester_id, semester, year) VALUES
(1, 'Fall', 2020),
(2, 'Spring', 2021),
(3, 'Summer', 2021),
(4, 'Fall', 2021)
...
INSERT INTO public_student (student_id, lastname, firstname, program_id, declare_major, total_credit, total_gpa, entered_as, admit_term, predicted_graduation_semester, degree, minor, internship) VALUES
...
INSERT INTO public_student_record (student_id, course_id, semester, grade, how, transfer_source, earn_credit, repeat_term, test_id, offering_id) VALUES
